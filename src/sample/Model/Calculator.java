...
public class Calculator extends MathOperations {
    ...
    // set fullOperation
    public String enterFullOperation(String fullOperation_t){
        this.setSignedOfResult("+");
        setFullOperation(fullOperation_t);
                ...
                if (getFullOperation().indexOf(selectedOperator) != -1) {
                    ...
                    switch (selectedOperator) {
                        ...
                        case '-':
                            ...
                            break;
                        case '^':
                            setResultOfOperation(super.powerValues(this.leftValue, this.rightValue));
                        default:
